...
class micro_doppler_signature:
    ...
    def main(self):
        rospy.init_node('micro_doppler_node_0')
        self.sub_ = rospy.Subscriber('/node1_radarinterface/radar_scan_0', RadarScan, self.ti_doppler_parser)
        self.pub_ = rospy.Publisher('/ti_mmwave/micro_doppler_0', MicroDoppler_m, queue_size=100)
        rospy.spin()

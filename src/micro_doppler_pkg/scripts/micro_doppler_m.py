...
class micro_doppler_signature:
    def __init__(self, nd = 0, host_velocity = 0,topic_name = '/node1_radarinterface/radar_scan_0'):
        self.frame_id = 'micro_doppler'
        self.host_velocity = host_velocity
        self.time_domain_bins = 20
        self.sub_ = rospy.Subscriber(topic_name, RadarScan, self.ti_doppler_parser)
...
if __name__ == '__main__':
    ...
    micro_doppler_signature(nd, host_velocity=0, topic).main()